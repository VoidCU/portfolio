...
const jsonLd = [
  {
    ...
    description:
      "Full-stack engineer from Kathmandu, Nepal specializing in SaaS architecture, AI/ML systems, and mobile development.",
    worksFor: [
  ...
  },
  {
    ...
    name: "Saroj Prasad Mainali",
    description:
      "Portfolio and blog of Saroj Prasad Mainali, full-stack engineer from Kathmandu.",
