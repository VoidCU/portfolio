...
const OrbitalScene = dynamic(() => import("./OrbitalScene"), {
  ssr: false,
  loading: () => <div className="orbital-fallback" />,
});
...
export default function CinemaHome() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div className="hero-landscape" style={{ y: still ? 0 : y }}>
          <Image
            src="/assets/art/orbital-himalaya.webp"
            alt=""
            fill
            priority
        ...
        >
          <div className="hero-eyebrow">
            <span className="status-dot" /> FULL-STACK ENGINEER & AI BUILDER
          </div>
          <h1 id="hero-title">
            <span>Beyond the</span>
            <span className="hero-second">
              ordinary<span className="hero-period">.</span>
            </span>
          </h1>
          <div className="hero-intro">
            ...
            <div>
              <p>
                I’m Saroj. I turn complex ideas into
                <br className="desktop-break" /> digital experiences that make a
                difference.
              </p>
        ...
        <div className="expertise-layout">
          <div className="expertise-intro">
            <Reveal>
              ...
              <p className="section-lede">
                The best solutions happen where worlds meet.
              </p>
            </Reveal>
            <div
            ...
            >
              ...
              <span className="orbital-caption">THE ENGINEERING WORKSHOP</span>
            ...
            <Reveal key={post.slug}>
              ...
              >
                <div className="journal-art" aria-hidden="true">
                  <Image
                    src={`/assets/art/${["story-workshop", "story-origin", "story-horizon"][i]}.webp`}
                    alt=""
                    fill
      ...
      <section id="contact" className="cinema-contact">
        <div className="contact-horizon" aria-hidden="true">
          <Image
            src="/assets/art/story-horizon.webp"
            alt=""
            fill
            sizes="100vw"
          />
