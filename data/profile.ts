export const profile = {
  ...
  featuredProjects: [
    {
      index: "06",
      name: "Auctionmandu",
      tagline: "Featured / Nepal’s bank auction discovery platform",
      desc: "Bringing bank auction listings into one searchable experience. Discover land, houses, apartments and vehicles through location filters, an interactive map, and companion mobile apps.",
      tech: ["Next.js", "React Native", "Expo", "TypeScript", "MapLibre"],
      url: "https://auctionmandu.com/",
      github: null,
    ...
    },
    {
      index: "02",
      name: "Genzlink",
      tagline: "Nearby opportunities. One mobile app.",
      desc: "A map-first discovery app for jobs, accommodation, businesses and used vehicles. Explore nearby listings, switch between map and list views, and save the opportunities that matter.",
      tech: ["React Native", "Expo", "TypeScript", "MapLibre"],
      url: "https://www.genzlinkapp.com/",
      github: null,
      status: "LIVE" as const,
    },
    {
    ...
    },
    {
      ...
      url: null,
      github:
        "https://github.com/VoidCU/Handwritten-Devanagari-Character-Recognition",
  ...
  clients: [
    ...
    {
      index: "08",
      name: "sunshine.com.np",
      category: "Hospitality",
      url: "https://sunshine.com.np",
    },
    { index: "09", name: "Nexsus Education", category: "EdTech", url: null },
    {
      index: "10",
      name: "SAHE NSW",
      category: "Government / Edu",
      url: "https://sahe.nsw.edu.au",
    },
    {
      index: "11",
      name: "visaxsolutions.com",
      category: "Immigration",
      url: "https://visaxsolutions.com",
    },
    {
      index: "12",
      name: "amarnepal.com",
    ...
    {
      index: "13",
      name: "Agrimvoyage.com",
      category: "AgriTech",
      url: "https://agrimvoyage.com",
    },
    {
      index: "14",
      name: "agrimbooking.com",
      category: "AgriTech",
      url: "https://agrimbooking.com",
    },
    {
      index: "15",
      name: "KSeventsco.com",
      category: "Events & Ticketing",
      url: "https://kseventsco.com",
    },
    {
      index: "16",
      name: "KS Photography Station",
